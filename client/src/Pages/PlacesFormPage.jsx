...
<div>
                    <form onSubmit={addNewPlace}>
                        {preInput('Title', 'Title for your place. should be sort and cachy as in advertisement')}
                        ...
                        <div className="grid gap-2 mt-2 sm:grid-cols-3">
                            ...
                            <div>
                                ...
                                <input type="number" value={maxGuests} onChange={ev => setMaxGuests(ev.target.value)} placeholder="" />
                            </div>
                        </div>
